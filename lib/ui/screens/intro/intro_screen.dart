          ...
          children: [
            Padding(
              ...
              child: Column(
                ...
                children: [
                  CustomText(text: " Top",fontSize: 15.sp,fontWeight: FontWeight.bold,color: greyColor,),
                  kSizedBoxH10,
                  Expanded(
                    child: GridView.builder(
                        ...
                        itemBuilder: (context, index) {
                         return const CustomFollowWidget(label: "Premier League", image: logoImg, subLabel: "England");
        ...
        bottomNavigationBar: Container(
          ...
          child: Row(
            ...
            children: [
              ...
              Icon(Icons.arrow_forward_ios, color: secondaryColor,size: 20.w,)
            ],
          ),
        )
      ),
